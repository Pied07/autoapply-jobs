...
export async function scrapeGoogleJobs(params: {
  ...
  try {
    ...
    for (const item of scrapedJobs) {
      ...
      // Typical structure:
      // [0] Title: "Senior software java developer"
      // [1] Company: "Cognizant"
      // [2] Location/Source: "Kolkata, West Bengal • via Shine"
      // [3] Date: "2 days ago"
      // [4] Type: "Full-time"
      ...
      // Attempt to extract original source
      ...
      if (!applyUrl) {
        // Fallback: search for company careers page
